...
<strong>Defend:</strong> Mythology isn’t normally used to defend.
...
> Once per session, you can <strong>[channel spirits from</strong> <span>or</span> <strong>project into]</strong> the otherworld by <strong>[description of ritual]</strong> when <strong>[description of circumstance]</strong>.
